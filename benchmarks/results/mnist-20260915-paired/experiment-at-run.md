...
and 180-second turn budget. Each arm has four turns (build, local view rename,
...
The 15 September revision increases the whole-turn budget from 90 to 180 seconds
for both arms. An awake ordinary attempt completed two document edits but had not
finished its model response at 90 seconds; that failed attempt is retained
separately. This is a new completion-budget pilot, not a passing result under the
old budget or a relaxation of the desired workspace interaction speed.
